...
fviz_eig(built_pca, main = "Built PCA",
         xlab = "Principal component", addlabels=TRUE)
...
```
The top 3 absolute loadings for Built PC1 are ss_env_rate_ln, rec_env_rate_ln, and ed_env_rate_ln. These components are contributing the most to the variation captured in Built PC1.
...
fviz_eig(land_pca, main = "Land PCA",
         xlab = "Principal component", addlabels=TRUE)

```
Land PC1 explains 27.7% of the total variation in the Land subdomain. PC2 explaines 14.2% of total variation in Land subdomain.
...
```
The top 3 absolute loadings for Land PC1 are pct_harvested_acres_ln, pct_disease_acres_ln, and pct_manure_acres_ln. These components are contributing the most to the variation captured in Land PC1.
The top 3 absolute loadings for Land PC2 are insecticide_ln, fungicide_ln, and pct_au_ln. These components are contributing the most to the variation captured in Land PC1.
...
#Built screeplot; percentage of total variance explained by each PC
fviz_eig(sociod_pca, main = "Sociod PCA",
         xlab = "Principal component", addlabels=TRUE)
...
```
The top 3 absolute loadings for Sociod PC1 are num_creatclass, pct_bs, and med_hh_value. These components are contributing the most to the variation captured in Sociod PC1.
The top 3 absolute loadings for Sociod PC2 are gini_est, pct_renterocc, and pct_fam_pov. These components are contributing the most to the variation captured in Sociod PC2.
...
#Built screeplot; percentage of total variance explained by each PC
fviz_eig(water_pca, main = "Water PCA",
         xlab = "Principal component", addlabels=TRUE)
...
```
The top 3 absolute loadings for Water PC1 are w_c2cl4_ln, w_trichlorene_ln, and w_benzene_ln These components are contributing the most to the variation captured in Water PC1.
The top 3 absolute loadings for Water PC2 are w_picloram_ln, w_dinoseb_ln, and w_endrin_ln These components are contributing the most to the variation captured in Water PC2.
