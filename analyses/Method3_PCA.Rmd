...
air_pc_loadings_df |> 
  ggplot(aes(x = air_components, y = PC1)) + 
  geom_col() +
  theme(legend.position = "bottom", axis.text.x = element_text(angle = 90, hjust = 1)) +
  geom_hline(yintercept = 0) +
  labs(title = "Air PC1 Loadings")

#Top 5 loadings with greatest magnitude in PC1
air_pc_loadings_df |> 
  ...
  labs(title = "Top 10 Loadings for 1st Principal Component")

```
The top 5 air component loadings with greatest magnitude are a_ebenzine_ln, a_c2hcl3_ln, a_co_ln, a_dbp_ln, a_hcl_ln. These components are contributing the most to the variation captured in Air PC1.
